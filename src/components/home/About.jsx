    ...
    >
      <div className="max-w-3xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          className="space-y-6 text-base text-foreground/80 leading-relaxed"
        >
          <p>
            I'm a Data Science graduate student at the <span className="text-foreground font-medium">University of Michigan</span> with
            ...
            <span className="text-foreground font-medium">Wells Fargo</span> and an AI startup.
          </p>

          <p>
            What excites me most is the intersection of <span className="text-foreground font-medium">machine learning theory and practical application</span>.
